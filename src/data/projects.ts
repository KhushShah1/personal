...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: [
      ...
      "I was also a forward-deployed engineer on a 6-person team that generated $2M in revenue, shipping a Salesforce integration for our contract parser, an invoicing-schedule dashboard, and more features and fixes.",
      "Now I'm rebuilding how our agents work: customer policies lived in deterministic Temporal workflows rewritten per customer, which didn't scale or catch edge cases. The new harness has the revenue module's agents produce schema-format output end to end, a human reviewer, and evals that gate moving live customer workloads to newer models.",
    ],
    size: "wide",
    motif: "terminal",
  },
